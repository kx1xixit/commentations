# Contributing to Commentations

This guide explains how to add features and blocks to Commentations.
...
Add the method to Commentations' class:
...
It is generally recommended to keep everything in `src/01-core.js` as that is how Commentations was made.
